package com.zoomcamera.petalamazic.utils;
...
public class RemoteConfigHelper {
    ...
    public void fetchData(Context context, long intervalSeconds, IOnFetchDone iOnFetchDone) {
        this.intervalSeconds = intervalSeconds;
        AGConnectConfig.getInstance().clearAll();
        AGConnectConfig.getInstance().fetch(intervalSeconds).addOnSuccessListener(configValues -> {
